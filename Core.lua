        ...
        general = {
            ...
            args = {
                DisableAutoAddSpells = {
                    ...
                    get = function() return UtilitiesPlus.db.global.DisableAutoAddSpells end,
                }
            }
        },
        waypoints = {
            ...
            args = {
                WaypointReachedMessage = {
                    ...
                    order = 1,
                    width = "full",
                    set = function(_, val) UtilitiesPlus.db.global.WaypointReachedMessage = val end,
                    get = function() return UtilitiesPlus.db.global.WaypointReachedMessage end
                },
                AutoRemoveWaypoints = {
                    type = 'toggle',
                    ...
                    order = 2,
                    width = "full",
                    set = function(_, val) UtilitiesPlus.db.global.AutoRemoveWaypoints = val end,
                    get = function() return UtilitiesPlus.db.global.AutoRemoveWaypoints end
                }
            }
        }
    }
